...
This is not just a traditional textbook but also a type of software. It is published in the electronic format of *Mathematica* notebook, which allows students/users to directly run, test, manipulate, customize, and copy and paste the code in *Mathematica*, a good way to learn a programming language and use/re-use its code.
